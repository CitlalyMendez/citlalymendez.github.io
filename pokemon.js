...
fetch(uri1)
    ...
    .then(data => CargarDatos(data, "nombre-pokemon1", "img-pokemon1", "descripcion-pokemon1"));
 
fetch(uri2)
    .then(response => response.json())
    .then(data => CargarDatos(data, "nombre-pokemon2", "img-pokemon2", "descripcion-pokemon2"));
